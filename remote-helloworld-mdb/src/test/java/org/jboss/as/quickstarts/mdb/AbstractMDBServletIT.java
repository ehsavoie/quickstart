...
public abstract class AbstractMDBServletIT {
    ...
    public void testSendToQueue() throws IOException, InterruptedException {
        ...
        assertEquals("<h1>Quickstart: Example demonstrates the use of <strong>Jakarta Messaging 3.1</strong> and <strong>Jakarta Enterprise Beans 4.0 Message-Driven Bean</strong> in JBoss EAP.</h1>", content[0].trim());
        ...
        assertEquals("<p><i>Go to your JBoss EAP server console or server log to see the result of messages processing.</i></p>", content[8].trim());
    }
